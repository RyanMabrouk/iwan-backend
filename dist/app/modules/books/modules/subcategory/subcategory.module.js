...
exports.SubcategoryModule = SubcategoryModule = __decorate([
    (0, common_1.Module)({
        ...
        providers: [repository_1.SubcategoryRepository, subcategory_service_1.SubcategoryService],
        exports: [repository_1.SubcategoryRepository, subcategory_service_1.SubcategoryService],
    })
], SubcategoryModule);
