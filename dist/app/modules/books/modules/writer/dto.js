...
exports.UpdateWriterDto = exports.NewWriterDto = void 0;
const class_validator_1 = require("class-validator");
const common_1 = require("@nestjs/common");
const TranslateDto_1 = require("../../../../shared/utils/TranslateDto");
class NewWriterDto {
}
exports.NewWriterDto = NewWriterDto;
__decorate([
...
], NewWriterDto.prototype, "name", void 0);
class UpdateWriterDto {
}
...
__decorate([
    ...
    (0, class_validator_1.IsNotEmpty)({ message: (0, TranslateDto_1.TranslateDto)('IsNotEmpty') }),
    __metadata("design:type", String)
], UpdateWriterDto.prototype, "name", void 0);
