...
const deepResolvePromises_1 = require("../utils/deepResolvePromises");
let ResolvePromisesInterceptor = class ResolvePromisesInterceptor {
    intercept(context, next) {
        return next.handle().pipe((0, operators_1.map)((data) => (0, deepResolvePromises_1.deepResolvePromises)(data)));
    }
};
